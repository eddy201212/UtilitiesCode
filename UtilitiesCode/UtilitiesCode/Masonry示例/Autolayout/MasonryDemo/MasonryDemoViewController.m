...
#import "AutoLayoutWithMasonry.h" //自己添加测试

@interface MasonryDemoViewController () <UITableViewDelegate, UITableViewDataSource>
...
- (void)viewDidLoad {
  ...
  self.controllers = @[[[BasicController alloc] initWithTitle:@"基础使用"],
                       ...
                       [[AutoLayoutWithMasonry alloc] initWithTitle:@"自己添加的其他方法333"],
                       ];
}
