//
//  AutolayoutWithPureLayout2.m
//  Utilities
//
//  Created by Eddy on 15/12/31.
//  Copyright © 2015年 ed. All rights reserved.
//

#import "AutolayoutWithPureLayout2.h"
#import "PureLayout.h"
...
@interface AutolayoutWithPureLayout2 ()
...
@implementation AutolayoutWithPureLayout2
...
- (void)setupDemo1
{
    ...
    [subviews autoDistributeViewsAlongAxis:ALAxisVertical alignedTo:ALAttributeVertical withFixedSize:80.0f insetSpacing:YES];
}
...
- (void)setupDemo2
{
    ...
    [subviews autoDistributeViewsAlongAxis:ALAxisHorizontal alignedTo:ALAttributeHorizontal withFixedSize:10.0f insetSpacing:NO];
}
...
- (void)setupConstraintsForCurrentDemo
{
    ...
    self.layoutConstraints = [NSLayoutConstraint autoCreateAndInstallConstraints:^{
